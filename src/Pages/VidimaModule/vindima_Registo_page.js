...
import VindimaRegisto from '../../components/VidimaModule/vindima_Registo_component';
...
const optionMenuArray = [
    {
        ...
        sub_menu: [
            {
                display: "-Registo de entrada de Uvas (REU)",
                linkData: {
                    filters: {
                        Tabs: {
                            Autorização: [
                    ...
                    actionbuttons: { Edit: false, Redirect: false, Delete: false, detailPopUp: true,DropdownVinRegisto:true },
                    popUpTabName: "Instalações vínicas",
                    listApilink: "/Vindima/ProducerAccount/GetAll",
                    listdefaultRequest: listdefaultRequest,
                    requestMethod: "post",
                    navbarOptionsYear: true,
                    TitleBartitle: "Registo de entrada de Uvas (REU)r",
            ...
            {
                display: "-Entregas por matrícula",
                linkData: {
                    filters: {
                        Tabs: {
                            Autorização: [
                    ...
                    requestMethod: "post",
                    navbarOptionsYear: true,
                    TitleBartitle: "Entregas por matrícular",
                    TitleBarlogo: "auditing",
                    TabName: [],
                    notAction : true,
                    groupfield: [
            ...
            },
            {
                ...
                linkData: {
                    ...
                    requestMethod: "post",
                    navbarOptionsYear: true,
                    TitleBartitle: "Detalhe de entregasr",
                    TitleBarlogo: "auditing",
                    TabName: [],
                    groupfield: [
                        {field : "Contratos"},
            ...
            {
                display: "-Viticultores com excesso de produção",
                linkData: {
                    filters: {
                        Tabs: {
                            Autorização: [
                    ...
                    requestMethod: "post",
                    navbarOptionsYear: true,
                    TitleBartitle: "Viticultores com excesso de produçãor",
                    TitleBarlogo: "auditing",
                    TabName: [],
                    notAction : true,
                    groupfield: [
            ...
            {
                display: "-Limites de produção por Entidade/CV",
                linkData: {
                    filters: {
                        Tabs: {
                            Autorização: [
                    ...
                    requestMethod: "post",
                    navbarOptionsYear: true,
                    TitleBartitle: "Limites de produção por Entidade/CVr",
                    TitleBarlogo: "auditing",
                    TabName: [],
                    notAction : true,
                    groupfield: [
...
class VindimaRegistoPage extends React.Component{
    constructor(props) {
        super(props);
    ...
    changeOption = (mainIndex, subIndex) => {
        ...
        window.location = "/vindima_registo?m=" + mainIndex + "&s=" + subIndex;
        return;
    }
        ...
        return (
            <div className="dashboard">
                ...
                <div className="container-fluid">
                    <VindimaRegisto selectedMainOption={this.state.selectedMainOption} date={new Date()} year={this.state.year} changeOption={(mainIndex, subIndex) => this.changeOption(mainIndex, subIndex)} optionMenuArray={optionMenuArray} linkData={this.state.linkData} selectedtitelotion={this.state.selectedtitelotion} />
                </div>
            </div>
        )
    }
...
export default VindimaRegistoPage;