...
class Main extends React.Component {
    ...
    cellRender=(tdElement, cellProps)=> {
        ...
        // }
            ...
            if(cellProps.field=="Status" && (cellProps.dataItem.status == 1 || cellProps.dataItem.status == "1"|| cellProps.dataItem.status == "Active" || cellProps.dataItem.status == "active" || cellProps.dataItem.status == "a" || 
             cellProps.dataItem.status == "A" )) {
                ...
                return (<td className="text-inactive"> Inactive </td>);
