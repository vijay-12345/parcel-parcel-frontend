...
class VindimaDesdobrar extends React.Component {
            ...
            <div className="modal-content">
                ...
                <div className="modal-body">
                    <div className="details">
                            ...
                            <div className="col-md-6">
                                <div className="input-box active-grey mb-2">
                                    <Input
                                        ...
                                        className="input-1"
                                        name="mov_Orig"
                                        value={this.state.propRow.mov_Orig || ''}
                                        label="Mov Orig"
                                        onChange={this.handleChange}
                                    />
                                </div>
                        ...
                        <h4 className="mt-4">Divisão / Transferência</h4>
                        <div className="row">
                            <div className="col-md-6">
                                <div className="input-box active-grey mb-2">
                                    <Input
...
export default VindimaDesdobrar;